...
public abstract class RelativePositionFactory<PARENT, TYPE> {
	...
	protected abstract class RelativePositionImpl<P extends PARENT, E> implements RelativePosition<P, TYPE> {
		...
		public void setValue(TYPE value) {
			...
			Validate.validState(context.isPropertyResolved(), "could not set value %s onto %s from %s", value, name, parentPosition);
		}
		...
		public boolean equals(Object obj) {
			...
			return Objects.equals(getFactory(), other.getFactory()) && Objects.equals(parentPosition, other.parentPosition);
		}
