...
public class DefaultImmutableChecker extends ImmutableChecker {
	...
	static {
		...
		Collections.<Class<?>> addAll(s, String.class, Enum.class, Annotation.class, Class.class, Arrays.asList().getClass());
		...
		boolean junk = Collections.addAll(s, Collections.singleton(null).getClass(), Collections.singletonList(null).getClass(), Collections
				.singletonMap(null, null).getClass());
